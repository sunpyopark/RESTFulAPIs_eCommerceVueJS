<template>
<nav class="navbar navbar-expand-sm navbar-green bg-white" role="navigation">
  <div class="container">
    <router-link to="/" class="navbar-brand mr-auto" >Web Mobile Store</router-link>
    <button
    ...
    <div class="collapse navbar-collapse" id="navbarTop" :class="{show: isNavOpen}">
      ...
      <ul class="nav navbar-nav">
        ...
        <li>
          <router-link to="/cart" class="btn btn-success-dark navbar-btn" tag="button">
            Checkout <span class="badge badge-dark">{{ numItems }} ($ {{ cartValue }})</span>
          </router-link>
        </li>
      </ul>
    </div>
